...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{figures/crb_sim_branching/cells_at_iter_0000009800.png}%
    \hspace{0.04\textwidth}%
    \includegraphics[width=0.48\textwidth]{figures/crb_sim_branching/cells_at_iter_0000060200.png}%
    \caption{\todo{caption}}
...
\begin{figure}[H]
    ...
    \includegraphics
        ...
        {figures/crb_sim_branching/fractal-dim-over-time.pdf}%
    \caption{\todo{caption}}
    \label{fig:fractal-dim-discretization}
\end{figure}
