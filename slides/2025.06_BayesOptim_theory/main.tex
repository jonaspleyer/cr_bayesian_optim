...
%\titlegraphic{\includegraphics[scale=0.3]{Figures/Freiburg.jpg}}
\logo{\includegraphics[scale=0.12]{Figures/20221107-UFR-logo-blue-rgb-344A9A.pdf} \hspace{4.5cm} \includegraphics[scale=0.45]{Figures/Freiburg.jpg}} 
    ...
    \begin{columns}
        \column{0.47\linewidth}
            \begin{enumerate}
                ...
                \item For initial sampling $\mathbf{D}_{n_0}$
...
{\nologo \frame{	
    ...
    For an initial input $\mathbf{D}_{n_0} = (x_1,..., x_{n_0})$
    the resulting prior distribution:
    \begin{equation*}
        f(\mathbf{D}_{n_0}) \propto N(\mathbf{\mu}_0(\mathbf{D}_{n_0}), \Sigma_0^2(\mathbf{D}_{n_0}))
    \end{equation*}

    \vspace{2mm}
    Here mean and covariance matrix function:
   \begin{equation*}
       \mathbf{\mu}_0(\mathbf{D}_{n_0}) = (\mathbf{\mu}_0(\tilde x_1), ..., \mathbf{\mu}_0(x_n))
   \end{equation*}

    \begin{equation*}
       \Sigma_0 (\mathbf{D}_{n_0}, \mathbf{D}_{n_0}) = \begin{pmatrix}
...
{\nologo \frame{	
    ...
    Given previous iteration step head $n$ points $\mathbf{D}_n = (x_1, ..., x_n)$
    ...
    Posterior mean:
    \begin{equation*}
        \mu_n (\tilde x) = \Sigma_0 (\tilde x, \mathbf{D}_n) \Sigma_0 (\mathbf{D}_n, \mathbf{x}_{1:n})^{-1} (f(\mathbf{D}_n)-\mu_0 (\mathbf{D}_n)) + \mu_0 (\tilde x)
    \end{equation*}
...
{\nologo \frame{	
    ...
    \vspace{3mm}
    \textbf{Upper-confidence based (UCB) algorithm}:
